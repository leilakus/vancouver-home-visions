      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            What Our <span className="bg-gradient-to-r from-yellow-700 to-yellow-800 bg-clip-text text-transparent">Clients Say</span>
          </h2>
            ...
            <div key={index} className="bg-gradient-to-br from-gray-50 to-yellow-50/30 rounded-lg p-8 hover:shadow-lg transition-all duration-300 border border-yellow-100">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-yellow-700 text-sm font-medium">{testimonial.role}</p>
                </div>
              </div>
            </div>
          ))}
