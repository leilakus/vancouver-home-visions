...
export const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      role: "Sutton West Coast Realty",
      image: "https://images.unsplash.com/photo-1721322800607-8c38375eef04?w=100&h=100&fit=crop&crop=face",
      content: "I've worked with many photographers, but none deliver the wow factor like Vancouver Real Estate Media. Their drone footage and virtual tours are game-changers.",
      rating: 5
    },
    {
      name: "Jennifer Park",
