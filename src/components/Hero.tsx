    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in">
          <Button onClick={scrollToContact} size="lg" className="bg-gradient-to-r from-yellow-700 to-yellow-800 hover:from-yellow-800 hover:to-yellow-900 text-lg px-8 py-3 shadow-lg hover:shadow-xl transition-all duration-300">
            Book Your Shoot
          </Button>
          <Button 
            ...
            variant="outline" 
            size="lg" 
            className="bg-white/10 border-yellow-500/50 text-white hover:bg-yellow-700/20 hover:border-yellow-400 text-lg px-8 py-3 transition-all duration-300"
          >
            View Portfolio
          </Button>
        </div>
